            ...
            <div className="max-w-7xl mx-auto px-3 md:px-6">
                <div className="flex flex-col md:flex-row items-center justify-between gap-4 md:gap-8">
                    ...
                    <div className="flex gap-2 md:gap-3">
                        ...
                        <a href="tel:+8801827595584" className="inline-flex items-center justify-center gap-1.5 md:gap-2 bg-white/10 text-white font-bold py-2 md:py-3 px-4 md:px-8 rounded-lg border border-white/30 hover:bg-white/20 transition-colors text-xs md:text-base">
                            <FiPhone /> Call Us
                        </a>
                    </div>
                </div>
