            ...
            <div className="max-w-5xl mx-auto px-4 md:px-8 -mt-6">
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 mb-10">
                    ...
                    <div className="lg:col-span-2 space-y-4">
                        {[
                            { icon: <FiMapPin size={20} />, title: "Visit Us", text: "BA - 64/3 South Badda, Dhaka - 1212" },
                            { icon: <FiPhone size={20} />, title: "Call Us", text: "+880 1827595584", href: "tel:+8801827595584" },
                            { icon: <FiMail size={20} />, title: "Email Us", text: "allion.agt@gmail.com", href: "mailto:allion.agt@gmail.com" },
                        ...
                        <div className="bg-white rounded-xl p-5 shadow-sm">
                            ...
                            <div className="flex gap-3">
                                ...
                                <a href="mailto:allion.agt@gmail.com" className="w-10 h-10 bg-red-50 text-red-600 rounded-lg flex items-center justify-center hover:bg-red-100 transition-colors"><FiMail size={20} /></a>
                            </div>
                        </div>
                    </div>
